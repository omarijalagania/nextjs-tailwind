...
const SellProperty = () => {
  return (
    <div class="max-w-screen-lg bg-white shadow-2xl rounded-lg mx-auto text-center py-8 mt-4 rounded border-l-4 border-black flex justify-between mb-10">
      <div className="ml-10 flex">        
        <div className="bg-green-300 w-12 h-12 rounded-full mr-5 mt-1">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mt-1 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m3 12 2-2m0 0 7-7 7 7M5 10v10a1 1 0 0 0 1 1h3m10-11 2 2m-2-2v10a1 1 0 0 1-1 1h-3m-6 0a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1m-6 0h6"/></svg>
        </div>
        <div >
      ...
      <div class=" flex justify-end">
        <div class="inline-flex justify-center rounded-full bg-black shadow w-48 h-12 mr-5 mt-1">
